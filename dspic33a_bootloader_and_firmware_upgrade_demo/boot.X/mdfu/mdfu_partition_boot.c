...
static size_t Read(uint32_t offset, size_t length, void* buffer)
{
     ...
     */
    const uint8_t* bootStart = (const uint8_t*)0x800000;
    
    size_t actualLength = length;
            
    (void)memcpy(buffer, &bootStart[offset], actualLength);
