...
#ifndef MDFU_COMMAND_PROCESSOR_H
#define	MDFU_COMMAND_PROCESSOR_H

enum MDFU_COMMAND_RESULT
{
    MDFU_COMMAND_SESSION_WAITING,
    MDFU_COMMAND_SESSION_IN_PROGRESS,
    MDFU_COMMAND_SESSION_COMPLETE,
    MDFU_COMMAND_SESSION_FAILED
};
...
#endif	/* MDFU_COMMAND_PROCESSOR_H */
