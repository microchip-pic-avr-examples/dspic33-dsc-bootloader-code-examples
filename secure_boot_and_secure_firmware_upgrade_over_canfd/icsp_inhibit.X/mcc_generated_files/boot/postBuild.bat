...
%OBJ_CPY% -I ihex -O binary "%projectDir%\%imageDir%\temp_original_copy.X.production.hex" "%projectDir%\%imageDir%\icsp_inhibit.X.production.bin"
...
del "%projectDir%\%imageDir%\icsp_inhibit.X.production.bin.signature.der"

del "%projectDir%\%imageDir%\icsp_inhibit.X.production.bin.signature.hex"
del "%projectDir%\%imageDir%\icsp_inhibit.X.production.bin.signature.bin"